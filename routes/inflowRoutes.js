...
module.exports = app => {
  app.post('/api/inflow', requireLogin, async (req, res) => {
    ...
    profile.target_savings += inflow.amount * 0.8
    profile.monthly_spend += inflow.amount * 0.2
    await profile.save()
  ...
  app.post('/api/inflow/delete', requireLogin, async (req, res) => {
    ...
    profile.target_savings -= inflow_obj.amount * 0.8
    profile.monthly_spend -= inflow_obj.amount * 0.2
    await profile.save()
  })
}
